...
const MONGO_URI = process.env.MONGO_URI_CAR || 'mongodb://localhost:27017/cardb';
const PORT = process.env.PORT_CAR || 6002;

mongoose.connect(MONGO_URI)
  .then(() => console.log('✅ MongoDB (Car) connected'))
  .catch(err => {
    console.error('❌ MongoDB (Car) connection error:', err.message);
    process.exit(1);
  });
...
app.listen(PORT, '0.0.0.0', () => console.log(`🚀 Car Service running on port ${PORT}`));
