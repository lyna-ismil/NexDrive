...
const MONGO_URI = process.env.MONGO_URI_ADMIN || 'mongodb://localhost:27017/admindb';
const PORT = process.env.PORT_ADMIN || 6001;

mongoose.connect(MONGO_URI)
  .then(() => console.log('✅ MongoDB (Admin) connected'))
  .catch(err => {
    console.error('❌ MongoDB (Admin) connection error:', err.message);
    process.exit(1);
  });
...
app.listen(PORT, '0.0.0.0', () => console.log(`🚀 Admin Service running on port ${PORT}`));
